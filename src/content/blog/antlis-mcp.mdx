...
I later wrote up how that widget works end to end — the frontend, wiring it to OpenRouter, and making it stream its answer like ChatGPT: [Making My Portfolio Chat Widget Stream Like ChatGPT](/blog/streaming-chat-widget).
